        ...
        a.ajax = function(z) {
            ...
            m.onreadystatechange = function() {
                ...
                if (4 === m.readyState) {
                    if (200 === m.status) {
                        a = m.responseText;
                        if ("json" === c.dataType) try { a = JSON.parse(a) } catch (e) { c.error && c.error(m, e); return }
        ...
        a.Chart.prototype.getDataRows =
            function(f) {
                ...
                for (w = B.length; w--;) x = B[w][0],
                    y = B[w][1], d = l[x], e.sort(function(b, a) { return b.xValues[x] - a.xValues[x] }), k = E(d), n[0].splice(y, 0, k), f && n[1] && n[1].splice(y, 0, k), c(e, function(b) {
                        var a = b.name;
